...
sudo perl -p -i -e 's/#input_l_y_minus_axis = "-0"/input_l_y_minus_axis = "-0"/g' /opt/retropie/configs/all/retroarch-joypads/MCP23017 Controller.cfg
sudo perl -p -i -e 's/#input_l_y_plus_axis = "-0"/input_l_y_plus_axis = "-0"/g' /opt/retropie/configs/all/retroarch-joypads/MCP23017 Controller.cfg
